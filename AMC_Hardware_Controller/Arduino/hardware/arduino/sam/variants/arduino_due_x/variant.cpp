...
#include "SerialBufferSizes.h"
 
uint8_t rx_data1[UART1_RX_SIZE];
uint8_t tx_data1[UART1_TX_SIZE];
 
RingBuffer rx_buffer1(rx_data1, UART1_RX_SIZE);
RingBuffer tx_buffer1(tx_data1, UART1_TX_SIZE);
...
uint8_t rx_data2[USART2_RX_SIZE];
uint8_t rx_data3[USART3_RX_SIZE];
uint8_t rx_data4[USART4_RX_SIZE];
uint8_t tx_data2[USART2_TX_SIZE];
uint8_t tx_data3[USART3_TX_SIZE];
uint8_t tx_data4[USART4_TX_SIZE];
 
RingBuffer rx_buffer2(rx_data2, USART2_RX_SIZE);
RingBuffer rx_buffer3(rx_data3, USART3_RX_SIZE);
RingBuffer rx_buffer4(rx_data4, USART4_RX_SIZE);
RingBuffer tx_buffer2(tx_data2, USART2_TX_SIZE);
RingBuffer tx_buffer3(tx_data3, USART3_TX_SIZE);
RingBuffer tx_buffer4(tx_data4, USART4_TX_SIZE);
...
//Serial1.setInterruptPriority(0);
//Serial2.setInterruptPriority(0);
//Serial3.setInterruptPriority(0);
